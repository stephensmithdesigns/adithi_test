...
if('undefined'!=typeof Waypoint){Waypoint.refreshAll();}}).mosaicflow({itemSelector:'.fl-mosaicflow-item',columnClass:'fl-mosaicflow-col',minItemWidth:400});});})(jQuery);(function($){var $window=$(window),$stick=$(".stickysidebar");function resize(){if($window.width()>768){return $stick.addClass('stick');}
$stick.removeClass('stick');}
